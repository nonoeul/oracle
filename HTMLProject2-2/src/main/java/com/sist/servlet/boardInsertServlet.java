...
public class boardInsertServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<form method=get action=boardInsertServlet>");
		...
		out.println("<td width=85%><textarea rows=10 cols=50 name=content></textarea required></td>");
		out.println("</tr>");
		out.println("<tr>");
...
/*
 	...
 	name=%EB%85%B8%EB%85%B8%EC%9D%84&
 ...
 */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			request.setCharacterEncoding("UTF-8"); //반드시해주고 들어가야 한다. 
			// 디코딩 => byte[]을 한글로 변환 
